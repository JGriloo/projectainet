...
class EstampaController extends Controller
{
    ...
    /**
     * Create a new encomenda instance after a valid registration.
     *
     * @param  array  $data
     * @return \App\Models\Encomenda
     */
    protected function checkout(array $data)
    {
        $oldCart = Session::get('cart');
        $cart = new Cart($oldCart);
        ...
        $encomenda = Encomenda::create([
            ...
            'tipo_pagamento' => 'MC',
            'ref_pagamento' => $data['ref_pagamento'],
        ]);
        $encomenda->save();
        return $encomenda;
    }
